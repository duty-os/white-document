...
<span data-type="color" style="color:rgb(51, 51, 51)"><span data-type="background" style="background-color:rgb(255, 255, 255)">用户验证通过通过 URL 参数中的 token 进行验证，token 来源参考：</span></span>[https://www.yuque.com/herewhite/sdk/quickstart#f3nvan](https://www.yuque.com/herewhite/sdk/quickstart#f3nvan)
